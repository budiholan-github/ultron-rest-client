...
public class ApiClientGeneralDelegate implements JavaDelegate {
	public void execute(DelegateExecution execution) {
		...
		ApiClientGeneral apiClient = null;
		...
		try {
			...
			apiClient = new ApiClientGeneral();
			text = apiClient.restClientService(requestParams);
			try {
